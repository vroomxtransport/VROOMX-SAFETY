        ...
        {step === 'preview' && carrierData && (
          <div className="p-4">
            ...
            <div className="p-3 rounded-lg bg-primary-50 border border-primary-200">
              ...
              <p className="text-[9px] text-zinc-400 dark:text-zinc-400 mt-2 text-center">
        ...
        {step === 'full' && carrierData && (
          <div className="p-4">
            ...
            <div className="text-center p-4 rounded-lg bg-gradient-to-br from-primary-50 to-primary-100 border border-primary-200">
              ...
              <p className="text-[10px] text-zinc-600 dark:text-zinc-300 mb-3">
              ...
              <p className="text-[9px] text-zinc-400 dark:text-zinc-400 mt-2">
            ...
            <button
              onClick={handleReset}
              className="mt-3 w-full text-[10px] text-zinc-600 dark:text-zinc-300 hover:text-primary-500 transition-colors flex items-center justify-center gap-1"
            >
