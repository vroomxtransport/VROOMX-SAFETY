...
const FeaturesSection = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      heading: 'CSA (Compliance, Safety, Accountability) Score Tracking',
      description: "Monitor your CSA scores across all 7 BASICs (Behavior Analysis and Safety Improvement Categories) in real-time. Get actionable recommendations to improve your safety rating.",
    ...
    },
    {
      ...
      heading: 'DQF (Driver Qualification Files) Management',
