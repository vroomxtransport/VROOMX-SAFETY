  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        >
          <source src="/videos/trucking-hero.mp4" type="video/mp4" />
        </video>
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-primary-900/90 via-primary-800/70 to-primary-900/40" />
      </div>
