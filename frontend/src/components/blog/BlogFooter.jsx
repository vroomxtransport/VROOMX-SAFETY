          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link to="/#features" className="text-white/70 text-sm hover:text-white transition-colors">Features</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link to="/contact" className="text-white/70 text-sm hover:text-white transition-colors">Contact</Link></li>
