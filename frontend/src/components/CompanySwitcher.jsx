  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-3 px-3 py-2 rounded-lg transition-colors w-full bg-zinc-100 dark:bg-white/5 hover:bg-zinc-200 dark:hover:bg-white/10"
        disabled={switching}
      >
        <div className="w-9 h-9 rounded-lg flex items-center justify-center bg-accent-100 dark:bg-white/10">
        ...
        <div className="flex-1 min-w-0 text-left">
          ...
          <p className="text-xs font-mono text-zinc-500 dark:text-white/60">
            DOT# {activeCompany.dotNumber}
          </p>
        </div>
        <FiChevronDown
          className={`w-4 h-4 transition-transform duration-200 ${isOpen ? 'rotate-180' : ''} text-zinc-500 dark:text-white/60`}
        />
      </button>
