 ...
 *
 * ES6 mirror of backend/config/rdrTypes.js — same data for frontend use.
 */

export const RDR_TYPES = {
  // ==================== CRASH (7) ====================
  CRASH_WRONG_CARRIER: {
    ...
    category: 'crash',
    reviewer: 'state',
    description: 'The crash record was assigned to the wrong motor carrier.',
    evidenceRequired: [
  ...
  CRASH_WRONG_DRIVER: {
    ...
    category: 'crash',
    reviewer: 'state',
    description: 'The crash record lists the wrong driver.',
    evidenceRequired: [
  ...
  CRASH_NOT_REPORTABLE: {
    ...
    category: 'crash',
    reviewer: 'state',
    description: 'The crash does not meet FMCSA reportable thresholds.',
    evidenceRequired: [
  ...
  CRASH_INCORRECT_INFO: {
    ...
    category: 'crash',
    reviewer: 'state',
    description: 'The crash record contains incorrect factual information.',
    evidenceRequired: [
  ...
  CRASH_CPDP: {
    ...
    category: 'crash',
    reviewer: 'fmcsa_hq',
    description: 'The crash was not preventable under the Crash Preventability Determination Program.',
    evidenceRequired: [
  ...
  CRASH_DUPLICATE: {
    ...
    category: 'crash',
    reviewer: 'state',
    description: 'The same crash has been recorded more than once.',
    evidenceRequired: [
  ...
  CRASH_MISSING: {
    ...
    category: 'crash',
    reviewer: 'state',
    description: 'A crash that should appear on the carrier\'s record is missing.',
    evidenceRequired: [
      { item: 'Police crash report', required: true },
  ...
  INSPECTION_NEVER_RECEIVED: {
    ...
    category: 'inspection',
    reviewer: 'state',
    description: 'The carrier/driver never received a copy of the inspection report.',
    evidenceRequired: [
  ...
  INSPECTION_CITATION_COURT: {
    ...
    category: 'inspection',
    reviewer: 'state',
    description: 'A citation was dismissed or reduced in court.',
    evidenceRequired: [
  ...
  INSPECTION_VIOLATION_INCORRECT: {
    ...
    category: 'inspection',
    reviewer: 'state',
    description: 'The violation code, description, or severity is incorrect; the violation is a duplicate; or an IEP should be assigned.',
    evidenceRequired: [
  ...
  INSPECTION_WRONG_CARRIER: {
    ...
    category: 'inspection',
    reviewer: 'state',
    description: 'The inspection was assigned to the wrong motor carrier.',
    evidenceRequired: [
  ...
  INSPECTION_WRONG_DRIVER: {
    ...
    category: 'inspection',
    reviewer: 'state',
    description: 'The inspection lists the wrong driver.',
    evidenceRequired: [
      { item: 'Driver employment records', required: true },
      { item: 'ELD/log data showing actual driver', required: true },
      { item: 'Dispatch records', required: false }
  ...
  INSPECTION_INCORRECT_OTHER: {
    ...
    category: 'inspection',
    reviewer: 'state',
    description: 'Other information on the inspection report is incorrect.',
    evidenceRequired: [
  ...
  INSPECTION_MISSING: {
    ...
    category: 'inspection',
    reviewer: 'state',
    description: 'An inspection that should appear on the carrier\'s record is missing.',
    evidenceRequired: [
  ...
  INSPECTION_DUPLICATE: {
    ...
    category: 'inspection',
    reviewer: 'state',
    description: 'The same inspection has been recorded more than once.',
    evidenceRequired: [
  ...
  INVESTIGATION: {
    ...
    description: 'Challenge information related to a compliance investigation.',
    evidenceRequired: [
  ...
  FINE_NOC_NOV: {
    ...
    category: 'investigation',
    reviewer: 'fmcsa_division',
    description: 'Challenge a fine issued from a Notice of Claim or Notice of Violation.',
    evidenceRequired: [
  ...
  CARRIER_INFO_MCS150: {
    ...
    reviewer: 'fmcsa_hq',
    description: 'Incorrect carrier information from MCS-150 filing.',
    evidenceRequired: [
  ...
  LI_INFORMATION: {
    ...
    category: 'registration',
    reviewer: 'fmcsa_hq',
    description: 'Incorrect liability insurance information.',
    evidenceRequired: [
  ...
  CARRIER_REGISTRATION: {
    ...
    category: 'registration',
    reviewer: 'fmcsa_hq',
    description: 'Carrier registration information is incorrect.',
    evidenceRequired: [
  ...
  OTHER: {
    ...
    category: 'other',
    reviewer: 'fmcsa_hq',
    description: 'Use when none of the other RDR types apply.',
    evidenceRequired: [
...
export const RDR_TYPE_CODES = Object.keys(RDR_TYPES);

export function getRdrTypesByCategory() {
  const grouped = {};
  for (const [, type] of Object.entries(RDR_TYPES)) {
...
export function toLegacyChallengeType(rdrCode) {
